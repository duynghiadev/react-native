      ...
      >
        <View style={styles.contentContainer}>
          ...
          >
            <ExpoImage
              source={{
                uri: "https://loodibee.com/wp-content/uploads/Netflix-N-Symbol-logo.png",
              }}
              style={{
                width: 20,
                height: 20,
          ...
          >
            <ExpoImage
              source={{
                uri: "https://www.netflix.com/tudum/top10/images/top10.png",
              }}
        ...
        <View style={styles.moreLikeThis}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 18 }}>
            <ThemedText style={styles.moreLikeThisTitle}>
              More Like This
            </ThemedText>
            <ThemedText style={[styles.moreLikeThisTitle, { opacity: 0.4 }]}>
              Trailers & More
            </ThemedText>
          </View>
